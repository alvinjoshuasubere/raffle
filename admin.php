...
<head>
    ...
    <style>
        ...
        .toast{pointer-events:auto;padding:14px 22px;border-radius:12px;font-size:14px;font-weight:600;color:#fff;box-shadow:0 8px 30px rgba(0,0,0,.12);animation:toastIn .4s cubic-bezier(.34,1.56,.64,1);max-width:380px;display:flex;align-items:center;gap:10px}
        .toast-success{background:linear-gradient(135deg,#10b981,#059669)}.toast-error{background:linear-gradient(135deg,#ef4444,#dc2626)}.toast-info{background:linear-gradient(135deg,#ec4899,#f472b6)}
        @keyframes toastIn{0%{opacity:0;transform:translateX(100%) scale(.8)}100%{opacity:1;transform:translateX(0) scale(1)}}
        .toast-out{animation:toastOut .3s ease forwards}@keyframes toastOut{0%{opacity:1;transform:translateX(0)}100%{opacity:0;transform:translateX(100%)}}
        .event-badge{background:#fdf2f8;color:#ec4899;padding:4px 14px;border-radius:20px;font-size:11px;font-weight:700;border:1px solid #fbcfe8;margin-left:10px}
